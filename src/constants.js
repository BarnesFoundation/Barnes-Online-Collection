...
export const OBJECTS_QUERY_SET_HAS_MORE_RESULTS =
...
export const ENSEMBLE_OBJECTS_QUERY_SET_IS_PENDING =
  "ENSEMBLE_OBJECTS_QUERY_SET_IS_PENDING";

// relatedObjectsQuery
export const RELATED_OBJECTS_QUERY_SET_IS_PENDING =
  "RELATED_OBJECTS_QUERY_SET_IS_PENDING";
...
// urls
export const MAIN_WEBSITE_DOMAIN =
  process.env.REACT_APP_WWW_URL || "//www.barnesfoundation.org";
export const CANONICAL_ROOT =
  process.env.REACT_APP_CANONICAL_ROOT ||
...
export const DEFAULT_TITLE_URL =
