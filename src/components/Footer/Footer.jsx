...
class Newsletter extends Component {
  constructor(props) {
    ...
    this.state = {
      isSubmitted: sessionStorage.getItem(NEWSLETTER_SESSION_STORAGE_KEY)
  ...
  submit = async () => {
    ...
    if (EMAIL_REGEX.test(value)) {
      ...
      try {
        await axios.post(NEWSLETTER_URL, {
          email: value,
  ...
  render() {
    ...
    if (isSubmitted !== SUBMISSION_STATUS.LOADING)
      processingClass = `hidden ${processingClass}`;

    let successClass = "m-newsletter__success";
    if (isSubmitted !== SUBMISSION_STATUS.COMPLETE)
      successClass = `hidden ${successClass}`;

    let formClass = "m-newsletter__signup";
    if (isSubmitted === SUBMISSION_STATUS.COMPLETE)
      formClass = `hidden ${formClass}`;

    let emailErrorClass = "form-field__error";
    if (isError !== ERROR_STATUS.USER)
      emailErrorClass = `hidden ${emailErrorClass}`;

    let serverErrorClass = "form-field__error";
    if (isError !== ERROR_STATUS.SERVER)
      serverErrorClass = `hidden ${serverErrorClass}`;
        ...
        <div className="m-newsletter">
          ...
          >
            <form className="form-field m-newsletter__field">
              <label className="visuallyhidden" htmlFor="subscribe">
          ...
          <div className="m-block m-block--no-border m-block__columns">
            <div className="m-block__column knight-logo">
              <p>
                <a href="https://knightfoundation.org/">
                  <img
                    width={285}
                    src="/images/knight-foundation-logo.svg"
            ...
            <div className="m-block__column">
              ...
              <div className="brand-links">
                <a
                  className="a-brand-link a-brand-link-on-grey a-brand-link--block brand-links__link"
                  href="https://www.barnesfoundation.org/collection/credits"
                >
                  Project Credits
                </a>
                <a
                  className="a-brand-link a-brand-link-on-grey a-brand-link--block brand-links__link"
                  href="https://www.barnesfoundation.org/collection/open-access-and-copyright"
                >
                  Open Access
                </a>
                <a
                  className="a-brand-link a-brand-link-on-grey a-brand-link--block brand-links__link"
                  href="https://www.barnesfoundation.org/copyright-and-image-licensing"
                >
                  Image Licensing
                </a>
              </div>
        ...
        <div className="container">
          <div className="g-footer__actions m-block m-block--no-border">
            <div className="g-footer__col">
              <div className="g-footer__cta">
                <div className="font-delta g-footer__cta-title">
                  <p>
                    <strong>Your support helps</strong>
                    <strong>
                      {" "}
                      research and conservation at the Barnes, so we can present
                ...
                <div className="m-btn-group">
                  <a
                    ...
                    href="https://tickets.barnesfoundation.org/orders/316/tickets"
                  >
                    Donate
                  </a>
                  <a
                    className="btn btn--100"
                    href="https://www.barnesfoundation.org/support/membership"
                  >
                    Become a Member
                  </a>
                </div>
          ...
          <div className="g-footer__auxiliary">
            <nav className="g-footer__nav" aria-labelledby="footernav-heading">
              <h2 id="footernav-heading" className="visuallyhidden">
                Useful links
              </h2>
              <a
                className="g-footer__nav__link"
                href={MAIN_WEBSITE_DOMAIN + "/accessibility"}
              >
                Accessibility
              </a>
              ...
              <a
                className="g-footer__nav__link"
                href={MAIN_WEBSITE_DOMAIN + "/terms"}
              >
                Terms &amp; Conditions
              </a>
              <a
                className="g-footer__nav__link"
                href={MAIN_WEBSITE_DOMAIN + "/privacy-policy"}
              >
                Privacy Policy
              </a>
              ...
              <a
                className="g-footer__nav__link"
                href={MAIN_WEBSITE_DOMAIN + "/non-discrimination"}
              >
                Non-discrimination
              </a>
              ...
              <a
                className="g-footer__nav__link"
                href={MAIN_WEBSITE_DOMAIN + "/copyright-and-image-licensing"}
              >
            ...
            <div className="g-footer__social-container">
              <nav
                ...
                aria-labelledby="socialnav-heading"
              >
                <h2 id="socialnav-heading" className="visuallyhidden">
                  Find us on social media
                </h2>
                <a
                  className="g-footer__social__link"
                  href="http://www.facebook.com/barnesfoundation"
                >
                  <svg width={20} height={20}>
                    <title>facebook</title>
                    <use xlinkHref="#icon--icon_facebook" />
                  </svg>
                </a>
                <a
                  className="g-footer__social__link"
                ...
                >
                  <svg width={20} height={20}>
                    <title>twitter</title>
                    <use xlinkHref="#icon--icon_twitter" />
                  </svg>
                </a>
                <a
                  className="g-footer__social__link"
                  href="http://www.youtube.com/barnesfoundation"
                >
                  <svg width={20} height={20}>
                    <title>youtube</title>
                    <use xlinkHref="#icon--icon_youtube" />
                  </svg>
                </a>
                <a
                  className="g-footer__social__link"
                  href="https://instagram.com/barnesfoundation/"
                >
                  <svg width={20} height={20}>
                    <title>instagram</title>
                    <use xlinkHref="#icon--icon_instagram" />
                  </svg>
                </a>
              </nav>
              <a
                className="g-footer__a17"
                href="http://area17.com/?utm_source=http%3A%2F%2Fwww.barnesfoundation.org%2F&utm_medium=referral&utm_campaign=footer-credit-2016"
              >
                Site by AREA 17
              </a>
            </div>
