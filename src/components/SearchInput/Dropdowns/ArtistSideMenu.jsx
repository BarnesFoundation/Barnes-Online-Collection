...
const ARTISTS_RADIOS = {
  ABUNDANCE: "Abundance",
  ALPHABETICAL: "Alphabetical ",
};
const ARTISTS_RADIOS_ARRAY = [
  ARTISTS_RADIOS.ABUNDANCE,
      ...
      <div>
        <div className="side-menu__radio-selection-container">
          {ARTISTS_RADIOS_ARRAY.map((value) => {
            ...
            if (isActive)
              radioTextClassNames = `${radioTextClassNames} side-menu__radio-text--active`;
...
const mapDispatchToProps = (dispatch) =>
  bindActionCreators(Object.assign({}, { toggleArtistMenu }), dispatch);
const connectedArtistSideMenu = connect(
  null,
  mapDispatchToProps
)(ArtistSideMenu);
