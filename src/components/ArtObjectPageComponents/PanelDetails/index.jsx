...
class Thumbnail extends Component {
  ...
  render() {
    ...
    const renditionCaption =
      rendition.attributes["Artwork Caption (TMS)"] || "";
...
class Image extends Component {
  ...
  render() {
    ...
    const showZoomImageView = Boolean(
      !didCatchFailure && object.id && activeImageIndex === 0
    );
    ...
    if (activeImageIndex === 0) {
      ...
      const imageThumbnailPreview = renditions[activeImageIndex].proxies.find(
        (proxy) => {
      ...
      <div>
        ...
        <div className="image-caption">
          {object.people && (
            ...
            >
              {object.people}. {object.title}, {object.displayDate}.{" "}
              {object.invno}. {object.creditLine}
            </div>
          )}
        </div>
      </div>
