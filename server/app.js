  ...
  axios
    ...
    .then(axios.spread((objectDescriptors, relatedObjects) => {
      ...
      const distances = sources.map(source => {
        ...
        const descriptorKeys = filteredKeys.filter(key => key in objectDescriptors)
        ...
        const normalizedDistance = distance / descriptorKeys.length
